...
$arrInfo	= parseSell($strList);
//print_r($arrInfo);
$byerId		= isset($arrInfo[0]['id']) ? " - {$arrInfo[0]['id']}" : "";
$byerName	= isset($arrInfo[0]['byer']) ? "({$arrInfo[0]['byer']})" : "";
$iTotal		= $iPostage;
...
<table border="0">
  <tr>
    <td colspan="5" align="center"> 购 物 清 单<?php print("{$byerId}{$byerName}"); ?></td>
  </tr>
  <tr>
